 ...
 *
 */
public class RedissonJsonJacksonCodec extends BaseCodec {

    public static final RedissonJsonJacksonCodec INSTANCE = new RedissonJsonJacksonCodec();
    ...
    public RedissonJsonJacksonCodec() {
        this(new ObjectMapper(),true);
    }

    public RedissonJsonJacksonCodec(ClassLoader classLoader) {
    ...
    public RedissonJsonJacksonCodec(ObjectMapper mapObjectMapper, boolean setMapperVisibility) {
